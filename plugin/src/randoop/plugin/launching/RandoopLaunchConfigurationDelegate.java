...
public class RandoopLaunchConfigurationDelegate extends AbstractJavaLaunchConfigurationDelegate {
  ...
  @Override
    ...
    try {
      ...
      launch.setAttribute(RandoopLaunchConfigurationConstants.ATTR_PORT, String.valueOf(fPort));
