package randoop.plugin.internal.core.launchConfigurations;
...
public class IRandoopLaunchConfigurationConstants {
  ...
  public static final String ID_RANDOOP_TEST_GENERATION = "randoop.plugin.launchConfigType"; //$NON-NLS-1$
