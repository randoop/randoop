...
public class IRandoopLaunchConfigurationConstants {
  ...
  public static final String ATTR_TEMP_FOLDER = RandoopPlugin.getPluginId() + ".TEMP_FOLDER"; //$NON-NLS-1$
  
  public static final String ATTR_ALL_JAVA_TYPES = RandoopPlugin.getPluginId() + ".ALL_JAVA_TYPES"; //$NON-NLS-1$
  
  public static final String ATTR_CHECKED_JAVA_ELEMENTS = RandoopPlugin.getPluginId() + ".CHECKED_JAVA_ELEMENTS"; //$NON-NLS-1$
