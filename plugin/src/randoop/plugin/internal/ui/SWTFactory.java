...
public class SWTFactory {
   ...
   * NOP if the button's layout data is not an instance of <code>GridData</code>
   * .
   * 
   * @param the
   ...
   * @since 3.3
   */
  public static CLabel createWrapCLabel(Composite parent, String text,
      Image image, int hspan, int wrapwidth) {
   ...
   * 
   */
  public static Text createSingleText(Composite parent, int style, int hspan) {
