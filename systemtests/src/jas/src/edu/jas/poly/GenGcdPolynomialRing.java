...
/*
 * $Id: GenGcdPolynomialRing.java 1663 2008-02-05 17:32:07Z kredel $
 */
...
public class GenGcdPolynomialRing<C extends GcdRingElem<C> > 
    ...
    @Override
     public GenGcdPolynomialRing<C> extend(int i) {
        ...
        GenGcdPolynomialRing<C> pfac 
            = new GenGcdPolynomialRing<C>(coFac,nvar+i,to,v);
        return pfac;
    }
    ...
    @Override
     public GenGcdPolynomialRing<C> reverse(boolean partial) {
        ...
        GenGcdPolynomialRing<C> pfac 
            = new GenGcdPolynomialRing<C>(coFac,nvar,to,v);
