// I removed ReverseComparator because its code has an application of
// the >>> operator, which jtb fails on (we use jtb for instrumenting
// classes for branch coverage).
