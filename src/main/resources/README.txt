...
java -cp "build/libs/randoop-all-4.2.0.jar:$CHECKERFRAMEWORK/checker/dist/checker-qual.jar" randoop.resource.generator.MethodListGen $CHECKERFRAMEWORK/checker/dist/jdk8-jar src/main/resources
