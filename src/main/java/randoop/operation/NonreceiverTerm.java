...
public final class NonreceiverTerm extends CallableOperation {
   ...
   *         given type.
   */
  static NonreceiverTerm createNullOrZeroTerm(GeneralType type) {
   ...
   * {@link NonreceiverTerm#toParseableString(GeneralType, TypeTuple, GeneralType)}
   *
   * @param s
  ...
  public static TypedOperation parse(String s) throws OperationParseException {
    ...
    GeneralType type;
    try {
      type = GeneralType.forName(typeString);
