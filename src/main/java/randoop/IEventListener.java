...
/**
 * Defines various event during Randoop's generation at which an implementing
 * class can be notified and perform some action.
 */
public interface IEventListener {

  /**
   * Called immediately at the start of test generation, before any generation
   * steps have occurred.
   */
   ...
   *
   * @param s
   *          sequence that was generated and executed in the last generation
   ...
   * @see randoop.sequence.AbstractGenerator
   *
   * @param true if generation should stop, false otherwise.
   */
