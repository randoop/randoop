 ...
 * as a public instance method with no parameters in the given class, annotated with a <code>
 * @CheckRep</code> annotation, and have return type <code>boolean</code> or <code>void</code> . In
