 ...
 * field belongs to the class, and whether the types match.
 *
 */
public class FieldParser {
   ...
   *
   * @param s
   *          a string in the form of "TYPE:FIELDNAME"
   * @return a reference to a PublicField object represented by the pair in the
   *         string.
   * @throws OperationParseException
   *           if input string is not expected format.
   * @see AccessibleField
   */
