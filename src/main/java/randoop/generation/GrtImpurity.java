...
public class GrtImpurity {
   ...
   *
   * <p>This is the main entry point for the GRT Impurity. This method will append additional
   * fuzzing statements to the input sequence to fuzz the input object. This will generate more
   * object states and potentially improve coverage for the unit test generated by Randoop by
   * triggering more branches.
   *
