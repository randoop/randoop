...
public class InstrumentingClassLoader extends ClassLoader {
   ...
   * version of the class under test, preventing us from instrumenting the specified class. Resolve
   * will be false for all calls to this method since the only source that invokes this method is
   * {@link CoverageTracker} which calls loadClass without the resolve flag.
   *
