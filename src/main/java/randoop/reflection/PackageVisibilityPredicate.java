 ...
 * field relative to a particular package. A top-level class is accessible from
 * the package if it is public, or if it is package-private in the given
 * package. Otherwise, an element is accessible from the package if it is either
...
public class PackageVisibilityPredicate implements VisibilityPredicate {
   ...
   * @param otherPackage
   *          the package to test for relative accessibility
   * @return true if public set in modifiers or if otherPackage is the same as
