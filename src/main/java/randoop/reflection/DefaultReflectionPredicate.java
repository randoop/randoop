...
public class DefaultReflectionPredicate implements ReflectionPredicate {
  ...
  /**
   * Returns true if a bridge method should be discarded.
   *
  ...
  /**
   * Returns true if a bridge method is a <i>visibility</i> bridge, which allows access to a
  ...
  /**
   * Returns true if the {@code Class} is public.
   *
   * @param c the class
  ...
  /**
   * Returns true if the name of a field is included among the omitted field names.
   *
