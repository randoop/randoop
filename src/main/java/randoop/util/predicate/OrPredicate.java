...
/**
 * A Predicate that implements the or-else operator on two predicates. The or-else operator is a
 * short-circuited or, which only tests the second predicate if the first returns false.
 *
