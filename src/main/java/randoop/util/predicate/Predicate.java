...
public interface Predicate<T> {
   ...
   * @return a predicate that returns true if this predicate is true or the second predicate is
   *     true, and false if neither is true
   */
   ...
   * @return a predicate that returns true when this and the second predicate return true, and false
   *     otherwise
   */
