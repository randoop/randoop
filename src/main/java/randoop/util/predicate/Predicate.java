 ...
 *
 * @param <T>
 *          the type over which predicates operate
 */
public interface Predicate<T> {
   ...
   * @return a predicate that returns true if this predicate is true or the
   *         second predicate is true, and false if neither is true
   */
