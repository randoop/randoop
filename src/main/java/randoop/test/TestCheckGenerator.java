 ...
 *
 * Note: a generator does not determine which sequences become output. Instead a
 * generator produces the {@link TestChecks} objects that, for valid behaviors,
 * represent assertions in error or regression tests.
 */
public interface TestCheckGenerator {
   ...
   *
   * @param s
   *          the sequence for which checks are generated
