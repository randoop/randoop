      ...
      if (result instanceof NotExecuted) {
        ...
        if (includeAssertions) {
          ...
          if (runtimeValue == null) {
            ...
            // GRT Fuzzing option's short fuzzing strategy results in ambiguous assertions
            // for primitive numbers. Use == for primitives since Java automatically
            // unboxes them when comparing with ==, which removes the ambiguity.
