...
/**
 * CloneVisitor is a visitor which will make a deep copy of a JavaParser AST node. Unlike the
 * CloneVisitor provided by JavaParser 2.4.0, this class will also copy each node's orphan comments.
 */
public class CloneVisitor implements GenericVisitor<Node, Object> {
  ...
  public Node visit(EmptyTypeDeclaration _n, Object _arg) {
    ...
    EmptyTypeDeclaration r =
        new EmptyTypeDeclaration(
  ...
  public Node visit(VariableDeclarator _n, Object _arg) {
    ...
    VariableDeclarator r =
        new VariableDeclarator(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), id, init);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(EmptyMemberDeclaration _n, Object _arg) {
    ...
    EmptyMemberDeclaration r =
        new EmptyMemberDeclaration(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn());
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
  ...
  public Node visit(IntersectionType _n, Object _arg) {
    ...
    IntersectionType r =
        new IntersectionType(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), elements);
    Comment comment = cloneNodes(_n.getComment(), _arg);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
  ...
  public Node visit(VoidType _n, Object _arg) {
    ...
    VoidType r =
        new VoidType(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn());
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(WildcardType _n, Object _arg) {
    ...
    WildcardType r =
        new WildcardType(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), ext, sup);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(ArrayInitializerExpr _n, Object _arg) {
    ...
    ArrayInitializerExpr r =
        new ArrayInitializerExpr(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), values);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(ClassExpr _n, Object _arg) {
    ...
    ClassExpr r =
        new ClassExpr(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), type_);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(EnclosedExpr _n, Object _arg) {
    ...
    EnclosedExpr r =
        new EnclosedExpr(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), inner);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(IntegerLiteralMinValueExpr _n, Object _arg) {
    ...
    IntegerLiteralMinValueExpr r =
        new IntegerLiteralMinValueExpr(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn());
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
  ...
  public Node visit(LongLiteralMinValueExpr _n, Object _arg) {
    ...
    LongLiteralMinValueExpr r =
        new LongLiteralMinValueExpr(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn());
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
  ...
  public Node visit(ThisExpr _n, Object _arg) {
    ...
    ThisExpr r =
        new ThisExpr(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), classExpr);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(MarkerAnnotationExpr _n, Object _arg) {
    ...
    MarkerAnnotationExpr r =
        new MarkerAnnotationExpr(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), name);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(TypeDeclarationStmt _n, Object _arg) {
    ...
    TypeDeclarationStmt r =
        new TypeDeclarationStmt(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), typeDecl);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(BlockStmt _n, Object _arg) {
    ...
    BlockStmt r =
        new BlockStmt(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), stmts);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(EmptyStmt _n, Object _arg) {
    ...
    EmptyStmt r =
        new EmptyStmt(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn());
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(ExpressionStmt _n, Object _arg) {
    ...
    ExpressionStmt r =
        new ExpressionStmt(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), expr);
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(BreakStmt _n, Object _arg) {
    ...
    BreakStmt r =
        new BreakStmt(
            _n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), _n.getId());
    r.setComment(comment);
    for (Comment oc : _n.getOrphanComments()) {
      r.addOrphanComment(oc);
    }
  ...
  public Node visit(TypeExpr n, Object arg) {
    ...
    TypeExpr r =
        new TypeExpr(n.getBeginLine(), n.getBeginColumn(), n.getEndLine(), n.getEndColumn(), t);
