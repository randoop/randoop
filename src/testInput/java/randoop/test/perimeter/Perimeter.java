 ...
 *
 * <p>The algorithm computes the total perimeter of a region in a binary image represented by a
 * quadtree. The algorithm was presented in the paper:
 *
 * <p><cite> Hanan Samet, "Computing Perimeters of Regions in Images Represented by Quadtrees," IEEE
 * Transactions on Pattern Analysis and Machine Intelligence, PAMI-3(6), November, 1981. </cite>
 *
 * <p>The benchmark creates an image, count the number of leaves on the quadtree and then computes
 * the perimeter of the image using Samet's algorithm.
 */
