 ...
 *
 * <p>Instances of {@code java7.util7.Random} are threadsafe.
 * However, the concurrent use of the same {@code java7.util7.Random}
 * instance across threads may encounter contention and consequent
 * poor performance. Consider instead using
 * {@link java.util.concurrent.ThreadLocalRandom} in multithreaded
 * designs.
 *
 * <p>Instances of {@code java7.util7.Random} are not cryptographically
