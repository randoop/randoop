 ...
 * method of <tt>String</tt> or the java2.util2.regex package instead.
 * <p>
...
public class StringTokenizer implements Enumeration {
  ...
  public String nextToken() {
    ...
    currentPosition =
        (newPosition >= 0 && !delimsChanged) ? newPosition : skipDelimiters(currentPosition);
   ...
   * @see     java2.util2.StringTokenizer#hasMoreTokens()
   */
   ...
   *               tokenizer's string.
   * @see        java2.util2.Enumeration
   * @see        java2.util2.StringTokenizer#nextToken()
   */
