...
public class IdentityHashMap extends AbstractMap implements Map, java.io.Serializable, Cloneable {
  ...
  public Object put(Object key, Object value) {
    ...
    tab[i] = k;
    tab[i + 1] = value;
    if (++size >= threshold) resize(len); // len == 2 * current capacity.
    return null;
  }
   ...
   * itself as an entry.
   */
  private class EntryIterator extends IdentityHashMapIterator implements Map.Entry {
    public Object next() {
      nextIndex();
      return this;
    }
  ...
  private class KeySet extends AbstractSet {
    ...
    public int hashCode() {
      int result = 0;
      for (Iterator i = iterator(); i.hasNext(); ) result += System.identityHashCode(i.next());
      return result;
    }
  }
