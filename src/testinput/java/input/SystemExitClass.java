...
public class SystemExitClass {
  ...
  /**
   * This method calls {@code System.exit(value)} if {@code value} is not equal to the value of this object.
   *
   * @param value the value to check against the value of this object
   *
   * @return true if {@code value} is the same as the value of this object, otherwise does not return
   */
