...
/**
 * This is code from issue #120 reported by user Changmed modified slightly to force creation of NaN
 * value by computation. Test is to ensure that does not result in flaky tests.
 */
public class NaNBadness {

  private static final int LONG_BYTE_ARRAY_LEN = 8;

  public static double getBadNaN() {
    return toDouble(toByteArray(-1));
  }
