...
public class BlowsUp {
    public BlowsUp() { /* No code. */ }
    @Override public String toString() { throw new ToStringBlowsUp(); }
    @Override public int hashCode() { throw new HashcodeBlowsUp(); }
    @Override public boolean equals(Object o) { throw new EqualsBlowsUp(); }
