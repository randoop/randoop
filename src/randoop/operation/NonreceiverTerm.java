...
public final class NonreceiverTerm extends AbstractOperation implements Operation, Serializable {
  ...
  public static NonreceiverTerm parse(String s) throws OperationParseException {
    ...
    if (colonIdx == -1) {
      String msg = "A primitive value declaration description must be of the form " + "<type>:<value>" + " but the description \"" + s
    ...
    if (typeString.matches(".*\\s+.*")) {
      String msg = "Error when parsing type/value pair " + s + ". A primitive value declaration description must be of the form " + "<type>:<value>"
          + " but the <type> description \"" + s + "\" contains invalid whitespace characters.";
      throw new OperationParseException(msg);
    }
    ...
    try {
      ...
      String msg = "Error when parsing type/value pair " + s + ". A primitive value declaration description must be of the form " + "<type>:<value>"
          + " but the <type> given (\"" + typeString + "\") was unrecognized.";
      throw new OperationParseException(msg);
    }
    ...
    if (type.equals(char.class)) {
      try {
        ...
        String msg = "Error when parsing type/value pair " + s + ". A primitive value declaration description must be of the form " + "<type>:<value>"
            + " but the <value> given (\"" + valString + "\") was not parseable.";
        throw new OperationParseException(msg);
      }
      ...
      if (valString.equals("null")) {
        ...
        String msg = "Error when parsing type/value pair " + s
