...
public class ExecutableSequence implements Serializable {
   ...
   * [this is wonky really belongs to execution]
   */
   ...
   */
  public ExecutableSequence(Sequence sequence,
      Execution exec, TestChecks checks) {
    this.sequence = sequence;
  ...
  public Object[] getRuntimeInputs(Sequence s, List<ExecutionOutcome> outcome,
   ...
   * That happens if some statement before the last one throws an exception.
   */
