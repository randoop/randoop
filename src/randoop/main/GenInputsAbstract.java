...
public abstract class GenInputsAbstract extends CommandHandler {
  ...
  /**
   * Whether to use the long format for outputting JUnit tests. The long format
   * emits exactly one line per statement, including primitive declarations, and
   * uses boxed primitives. This option is used in the branch-directed
   * generation project.
   */
  ///////////////////////////////////////////////////////////////////
  ...
  @Unpublicized
  /**
   * In long format, primitive values are stored in variables and the variables
   * are used, as in "int x = 3 ; foo(x)". In short format, primitive values are
   * directly added to methods, as in "foo(3)".
   */
