 ...
 * check whether the exception is classified as expected. Used in
 * {@link randoop.test.TestCheckGenerator} implementations to decide whether an
...
public interface ExceptionPredicate {
   ...
   * @param s
   *          the sequence where exception was thrown
