...
//NOTE: we haven't incorporated switch statements into the tool yet.
//So this class is dead code at the moment.
//Immutable. Contains line number, case number, etc. for a single
//switch case. A method sequence stores the set of CoverageAtom objects
//corresponding to the branche directions and switch cases covered by the sequence.
