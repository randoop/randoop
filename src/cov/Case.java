 ...
 *
 * 
 * Immutable. Contains line number, case number, etc. for a single switch case.
 * NOTE: We haven't incorporated switch statements into the tool yet. So this
 * class is dead code at the moment.
 *
 * A randoop.Sequence object stores the set of CoverageAtom objects
 * corresponding to the branch directions and switch cases covered by the
 * sequence.
 *
...
public class Case implements CoverageAtom, Serializable {
  ...
  public final int switchNumber; // Switch number recorded by coverage tracking
                                 // tool.
  public final int caseNumber; // The case that this atom represents.

  private static Map<Case, Case> savedBranchInfos = new LinkedHashMap<Case, Case>();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof Case))
      return false;
    Case other = (Case) o;
    return className.equals(other.className) && lineNumber == other.lineNumber && switchNumber == other.switchNumber && caseNumber == other.caseNumber;
  }
