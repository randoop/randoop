  ...
  public void uncompilablePredicateTest() throws ParseException, UnsupportedEncodingException {
    String failedCode =
        "import org.junit.FixMethodOrder;\n"
            ...
            + "        java.util.ArrayList<java.lang.String> arraylist_str2 = new"
            + " java.util.ArrayList<java.lang.String>();\n"
            + "        boolean b3 ="
            + " java.util.Collections.addAll((java.util.Collection<java.lang.String>)"
            + " arraylist_str2, str_array1);\n"
            + "        java.util.List<java.lang.Integer> list_i4 ="
            + " compileerr.WildcardCollection.getAnIntegerList();\n"
            + "        java.util.List<java.lang.Integer> list_i5 ="
            + " compileerr.WildcardCollection.getAnIntegerList();\n"
            + "        java.util.List<? extends java.lang.CharSequence> list_wildcard6 ="
            + " compileerr.WildcardCollection.munge(list_i4, list_i5);\n"
            + "        java.util.List<? extends java.lang.Cloneable> list_wildcard7 ="
            + " compileerr.WildcardCollection.munge((java.util.List<java.lang.String>)"
            + " arraylist_str2, list_i5);\n"
            + "        java.util.List<java.lang.String> list_str8 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<java.lang.Integer> list_i9 ="
            + " compileerr.WildcardCollection.getAnIntegerList();\n"
            + "        java.util.List<java.lang.Integer> list_i10 ="
            + " compileerr.WildcardCollection.getAnIntegerList();\n"
            + "        java.util.List<? extends java.lang.CharSequence> list_wildcard11 ="
            + " compileerr.WildcardCollection.munge(list_i9, list_i10);\n"
            + "        java.util.List<java.lang.Integer> list_i12 ="
            + " compileerr.WildcardCollection.getAnIntegerList();\n"
            + "        java.util.List<java.lang.Integer> list_i13 ="
            + " compileerr.WildcardCollection.getAnIntegerList();\n"
            + "        java.util.List<? extends java.lang.CharSequence> list_wildcard14 ="
            + " compileerr.WildcardCollection.munge(list_i12, list_i13);\n"
            + "        java.util.List<? extends java.util.ArrayList<java.lang.Integer>>"
            + " list_wildcard15 = compileerr.WildcardCollection.munge(list_i9, list_i13);\n"
            + "        java.util.List<? extends java.lang.CharSequence> list_wildcard16 ="
            + " compileerr.WildcardCollection.munge(list_str8, list_i9);\n"
            + "        java.util.List<java.lang.String> list_str17 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<java.lang.String> list_str18 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<? extends java.lang.Comparable<java.lang.String>>"
            + " list_wildcard19 = compileerr.WildcardCollection.munge(list_str17, list_str18);\n"
            + "        java.util.List<java.lang.String> list_str20 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<java.lang.String> list_str21 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<? extends java.lang.Comparable<java.lang.String>>"
            + " list_wildcard22 = compileerr.WildcardCollection.munge(list_str20, list_str21);\n"
            + "        java.util.List<? extends java.lang.Iterable<java.lang.Integer>>"
            + " list_wildcard23 = compileerr.WildcardCollection.munge(list_str17, list_str21);\n"
            + "        java.util.List<java.lang.String> list_str24 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<java.lang.String> list_str25 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<? extends java.lang.Comparable<java.lang.String>>"
            + " list_wildcard26 = compileerr.WildcardCollection.munge(list_str24, list_str25);\n"
            + "        java.util.List<java.lang.String> list_str27 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<java.lang.String> list_str28 ="
            + " compileerr.WildcardCollection.getAStringList();\n"
            + "        java.util.List<? extends java.lang.Comparable<java.lang.String>>"
            + " list_wildcard29 = compileerr.WildcardCollection.munge(list_str27, list_str28);\n"
            + "        java.util.List<? extends java.lang.Iterable<java.lang.Integer>>"
            + " list_wildcard30 = compileerr.WildcardCollection.munge(list_str24, list_str28);\n"
            + "        java.util.List<? extends java.util.List<? extends java.lang.CharSequence>>"
            + " list_wildcard31 = compileerr.WildcardCollection.munge(list_str17, list_str24);\n"
            + "        java.util.List<? extends java.lang.CharSequence> list_wildcard32 ="
            + " compileerr.WildcardCollection.munge(list_str8, list_str24);\n"
            + "        java.util.List<? extends java.util.Collection<? extends"
            + " java.util.Collection<? extends java.lang.Comparable<java.lang.String>>>>"
            + " list_wildcard33 = compileerr.WildcardCollection.munge(list_i5, list_str24);\n"
  ...
  public void compilablePredicateTest() throws ParseException, UnsupportedEncodingException {
    String compilableCode =
        "package foo.bar;\n"
            ...
            + " \"CompilablePredicateTestClass.test001\");\n"
