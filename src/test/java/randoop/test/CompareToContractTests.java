...
public class CompareToContractTests extends TestCase {
  ...
  // CompareToNotTransitive contract= new CompareToNotTransitive();
  // Decoration result
  //     = contract.evaluate(new LargerThanAnyNonString(), new LargerThanEveryone(), "y");
  // assertNotNull(result);
  // }
  ...
  // Decoration result = contract.checkFaultyBehavior(new EqualToEveryone(),
  //      new SmallerThanAnyone(), "baz");
  // assertNotNull(result);
  // }
