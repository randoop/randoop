...
public class PlayingCard {
  ...
  enum PackageEnum {  YOU, SHOULD, NOT, SEE, ME }
  private enum PrivateEnum { YOU, SHOULD, NOT, SEE, ME }
  
  public class WhyAmIHere { 
    private String justAsking = "really";
    public String getString() { return justAsking; }
  }
  ...
  static {
      for (Suit suit : Suit.values())
          for (Rank rank : Rank.values())
              prototypeDeck.add(new PlayingCard(suit, rank));
  }
}
