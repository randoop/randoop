...
public class ICSE07ContainersTest {
  ...
  public void testFibHeap() throws IOException {
    ...
    IStopper stopper =
        new IStopper() {
          ...
          public boolean shouldStop() {
            return FibHeap.branchFingerprints.size() >= numBranches;
          }
        };
    ...
    assertEquals(numBranches, FibHeap.branchFingerprints.size());
  }
  ...
  public void testBinTree() {
    ...
    IStopper stopper =
        new IStopper() {
          @Override
          public boolean shouldStop() {
            return BinTree.branchFingerprints.size() >= numBranches;
          }
        };
    Set<String> excludeNames = new TreeSet<>();
    for (Class<?> c : classList) {
    ...
    assertEquals(numBranches, BinTree.branchFingerprints.size());
  }
  ...
  public void testTreeMap() {
    ...
    IStopper stopper =
        new IStopper() {
          @Override
          public boolean shouldStop() {
            return TreeMap.branchFingerprints.size() >= numBranches;
          }
        };
    Set<String> excludeNames = new TreeSet<>();
    for (Class<?> c : classList) {
    ...
    assertEquals(numBranches, TreeMap.branchFingerprints.size());
  }
  ...
  public void testBinomialHeap() {
    ...
    IStopper stopper =
        new IStopper() {
          @Override
          public boolean shouldStop() {
            return BinomialHeap.branchFingerprints.size() >= numBranches;
          }
        };
    Set<String> excludeNames = new TreeSet<>();
    for (Class<?> c : classList) {
    ...
    assertEquals(numBranches, randoop.test.issta2006.BinomialHeap.branchFingerprints.size());
  }
}
