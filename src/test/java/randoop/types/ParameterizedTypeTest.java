...
public class ParameterizedTypeTest {
  ...
  public void testAssignability() {
    ...
    GeneralType objALType =
            GenericClassType.forClass(ArrayList.class).instantiate( new SimpleClassOrInterfaceType(Object.class));
    ...
    GeneralType strCompType =
            GenericClassType.forClass(Comparable.class).instantiate( new SimpleClassOrInterfaceType(String.class));
    assertTrue(
    ...
    GeneralType intArrayType = ArrayType.ofElementType(new SimpleClassOrInterfaceType(Integer.class));
    assertFalse(
            "Comparable<Integer> not assignable from Integer[]",
            intCompType.isAssignableFrom(intArrayType));

    // class A<T> implements Comparable<T> {}
    GeneralType intAType = GenericClassType.forClass(A.class).instantiate(new SimpleClassOrInterfaceType(Integer.class));
    assertTrue(
            "A<Integer> assignable to Comparable<Integer>", intCompType.isAssignableFrom(intAType));

    // class B extends A<String> {}
    GeneralType strAType = GenericClassType.forClass(A.class).instantiate(new SimpleClassOrInterfaceType(String.class));
    ...
    GeneralType strHType = GenericClassType.forClass(H.class).instantiate(new SimpleClassOrInterfaceType(String.class));
    GeneralType strGType = GenericClassType.forClass(G.class).instantiate(new SimpleClassOrInterfaceType(String.class));
    ...
    GeneralType strIntDType =
            GenericClassType.forClass(
                    D.class).instantiate(new SimpleClassOrInterfaceType(String.class), new SimpleClassOrInterfaceType(Integer.class));
    assertTrue(
    ...
    GeneralType strIntEType =
            GenericClassType.forClass(
                    E.class).instantiate(new SimpleClassOrInterfaceType(String.class), new SimpleClassOrInterfaceType(Integer.class));
    // class F<T,S> extends E<S,T> {}
    GeneralType intStrFType =
            GenericClassType.forClass(
                    F.class).instantiate(new SimpleClassOrInterfaceType(Integer.class), new SimpleClassOrInterfaceType(String.class));
    assertTrue(
            "F<Integer,String> assignable to E<String,Integer>",
            strIntEType.isAssignableFrom(intStrFType));
    GeneralType strIntFType =
            GenericClassType.forClass(
                    F.class).instantiate(new SimpleClassOrInterfaceType(String.class), new SimpleClassOrInterfaceType(Integer.class));
    assertFalse(
