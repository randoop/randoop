...
public class ParameterizedTypeTest {
  ...
  public void testAssignability() {
    ConcreteType strALType = ConcreteType.forClass(ArrayList.class, new ConcreteSimpleType(String.class));
    ConcreteType intALType = ConcreteType.forClass(ArrayList.class, new ConcreteSimpleType(Integer.class));
    ConcreteType objALType = ConcreteType.forClass(ArrayList.class, new ConcreteSimpleType(Object.class));
    ...
    ConcreteType intCompType = ConcreteType.forClass(Comparable.class, new ConcreteSimpleType(Integer.class));
    ...
    ConcreteType strCompType = ConcreteType.forClass(Comparable.class, new ConcreteSimpleType(String.class));
    ...
    ConcreteType strIntDType = ConcreteType.forClass(D.class, new ConcreteSimpleType(String.class), new ConcreteSimpleType(Integer.class));
    ...
    // class E<S,T> {}
    ConcreteType strIntEType = ConcreteType.forClass(E.class, new ConcreteSimpleType(String.class), new ConcreteSimpleType(Integer.class));
    // class F<T,S> extends E<S,T> {}
    ConcreteType intStrFType = ConcreteType.forClass(F.class, new ConcreteSimpleType(Integer.class), new ConcreteSimpleType(String.class));
    assertTrue("F<Integer,String> assignable to E<String,Integer>", strIntEType.isAssignableFrom(intStrFType));
    ConcreteType strIntFType = ConcreteType.forClass(F.class, new ConcreteSimpleType(String.class), new ConcreteSimpleType(Integer.class));
