...
public class TestInputImportsWithSameClassName {
  ...
  /**
   * This test input uses ClassA belonging to package dir_a and ClassA belonging to package dir_b.
   * This test checks that the minimizer doesn't remove the fully-qualified type name for both
   * instances of ClassA.
   */
  @Test
