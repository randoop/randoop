 ...
 * number of Objects in the future.  At any point in time, getVariables()
 ...
 * multiple calls to getVariables() are not independent. Making two calls
 * to consecutive getVariables() without an accept() in between will
 ...
 *     }
 *     selectedLines = selector.getVariables();
 *   }
