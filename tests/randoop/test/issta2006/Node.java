...
public class Node {
    ...
    public Node(int c, FibHeap heap) {cost = c; right=this; left=this; this.heap=heap; }
    ...
    public List<Object> getAbstraction() {
        ...
        retval.add(right);
        retval.add(child);
        retval.add("min_cost_rel:" + Integer.valueOf(heap.min == null? -1 : heap.min.cost).compareTo(Integer.valueOf(this.cost)));
        return retval;
    }
