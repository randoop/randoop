...
public class ArrayTypeTest {
  ...
  public void testAssignability() {
    ...
    ConcreteType strALArrType = new ConcreteArrayType(ConcreteType.forClass(ArrayList.class, new ConcreteSimpleType(String.class)));
    ConcreteType intALArrType = new ConcreteArrayType(ConcreteType.forClass(ArrayList.class, new ConcreteSimpleType(Integer.class)));
