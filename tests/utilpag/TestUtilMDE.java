...
import utilpag.CountingPrintWriter;
import utilpag.Filter;
import utilpag.FuzzyFloat;
import utilpag.Intern;
import utilpag.LimitedSizeIntSet;
import utilpag.MathMDE;
import utilpag.Options;
import utilpag.OrderedPairIterator;
import utilpag.Pair;
import utilpag.UtilMDE;
import utilpag.WeakIdentityHashMap;
    ...
    // public static final class ComparableArrayComparatorLengthFirst implements Comparator
{
  ...
  public static void testInternObject() {
    ...
    try {
      Intern.intern(pOrig); // performed for side effect
