...
CLASS_DIRS := $(RANDOOP_HOME)/bin \
				...
				$(wildcard $(RANDOOP_HOME)/lib/*.jar) \
				$(INV)/java \
				$(INV)/java/lib/bcel.jar \

# OLD:  (I'm not sure why, but this fails for me.  Maybe a problem with my
# javac?  Anyway, the $(wildcard ...) above works.  -MDE)
#				$(RANDOOP_HOME)/lib/* \
